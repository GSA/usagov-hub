...
function getReport(reqId, noInit) {
            ...
            <div id="reportDownloadingUi">\
                ...
                <div id="reportDownloadingUiText" style="background-color: white; border: 1px solid gray; position: absolute; margin-left: 33%; width: 33%; line-height: 25px; padding: 20px; top: 200px;">\
                    ...
                    <span id="reportDownloadingUiComplete" style="display: none;">\
                        Report generation complete, you can <a download="search_state_details.csv">download it now</a>, or <a href="javascript: jQuery(\'#reportDownloadingUi\').remove(); void(0);">close this window</a>.\
                    </span>\
                </div>\
            <div>\
        ';
    ...
    // Request the report
    var ajax = jQuery.get('export-search-api-csv/search_state_details/search_text_multimedia_html?reqid='+reqId, function (data) {
        if ( data == 'working' ) {
