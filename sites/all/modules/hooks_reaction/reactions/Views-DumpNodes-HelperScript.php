<?php /*
    ...
    The purpose of this script is to assist the dump_nodes View with rendering - this Views uses 
    some custom functions that must be defined outside of the View.

    This helper script also assists in altering the query sent to MySQL for thsi View,
