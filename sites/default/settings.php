...
$envToDrupalMap = array(
    ...
    'strings' => array(
        ...
        'elasticsearch_ssl'       => 'CMP_DRUPAL_ELASTICSEARCH_SSL',
...
$databases = ['default'=>['default'=>[
    ...
    'password' => getenv('CMP_DRUPAL_DB_PASS'),
    'host'     => getenv('CMP_DRUPAL_DB_HOST'),
    'port'     => getenv('CMP_DRUPAL_DB_PORT'),
    'driver'   => getenv('CMP_DRUPAL_DB_DRIVER'),
 ...
 *
 */
$drupal_hash_salt = getenv('CMP_DRUPAL_HASH_SALT');
